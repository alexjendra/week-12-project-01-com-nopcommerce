...
public class TestSuite extends Utility {
    ...
    public void verifyProductAddedToShoppingCartSuccessfully() {
        ...
        //actions.moveToElement(goToCart).build().perform();
       /* WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
        WebElement element = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//button[contains(text(),'Go to cart')]")));
        element.click();
        */
        ...
        sendTextToElement(By.id("BillingNewAddress_FirstName"), "Khushbu");
        sendTextToElement(By.id("BillingNewAddress_LastName"), "Raval");
        ...
        sendTextToElement(By.id("BillingNewAddress_ZipPostalCode"), "E11 1111");
        sendTextToElement(By.id("BillingNewAddress_PhoneNumber"), "02233445566");
        ...
        sendTextToElement(By.id("CardholderName"), "Khushbu");
        sendTextToElement(By.id("CardNumber"), "11005885772233");
